...
internal static class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        if (args.Length > 0 && args[0] is "--runtime-status" or "--prepare-pack" or "--transcribe")
        ...
        { Console.Error.WriteLine("Usage: SoundOff.Desktop [project.soundoff.sqlite] | --self-test [--output directory] | --runtime-status | --prepare-pack <model> [languages] | --transcribe <audio> <output.json> [model] [device] [language]"); return 2; }
